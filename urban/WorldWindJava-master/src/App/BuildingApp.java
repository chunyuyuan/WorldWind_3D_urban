...
import layers.mercatortiledimagelayer.Google.GoogleMercatorLayer;
import layers.mercatortiledimagelayer.esri.EsriWorldStreetMapLayer;
...
public class BuildingApp
{
    public static class AppPanel extends JPanel
    {
        ...
        public AppPanel(Dimension canvasSize, boolean includeStatusBar)
        {
			...
			/*	Atmosphere
				2 NASA Blue Marble Image
				3 Blue Marble May 2004
				*/
				//System.out.println(layers.get(i));
				if(a.getName().equals("Atmosphere")){
					a.setEnabled(true);
					//System.out.println(layers.get(i).getName()+" "+layers.get(i).isEnabled());
				}else if(a.getName().equals("NASA Blue Marble Image")){
					a.setEnabled(true);	
				}else if(a.getName().equals("New Open Street Map")){
					a.setEnabled(false);	
				}else if(a.getName().equals("Blue Marble May 2004")){
					a.setEnabled(true);	
				}else if(a.getName().equals("OSM Buildings 3D")){
					a.setEnabled(false);	
				}else if(a.getName().equals("i-cubed Landsat")){
				...
				/*else {
				 ...
				 { if(layers.get(i).getName().equals("Place Names")){
					layers.get(i).setEnabled(false);
				}else if(layers.get(i).getName().equals("World Map")){
					layers.get(i).setEnabled(false);
				}else if(layers.get(i).getName().equals("Scale bar")){
					layers.get(i).setEnabled(false);
				}else if(layers.get(i).getName().equals("View Controls")){
					layers.get(i).setEnabled(false);
				}else if(layers.get(i).getName().equals("Compass")){
					layers.get(i).setEnabled(false);
				}else if(layers.get(i).getName().equals("Open Street Map")){
					layers.get(i).setEnabled(true);
				}else {
        ...
        protected void addGoogleLayers() {
         /*   GoogleMercatorLayer googleMercatorTerrainLayer = new GoogleMercatorLayer(GoogleMercatorLayer.GOOGLE_TERRAIN);
            ...
            googleMercatorMapLayer.setShowImageTileOutlines(true);
            ...
            this.addLayer(googleMercatorLabelLayer, PLACENAMESLAYERNAME);*/
             ...
             esriWorldStreetMapLayer.setEnabled(true);
         //    esriWorldStreetMapLayer.setShowImageTileOutlines(true);
             this.addLayer(esriWorldStreetMapLayer, "Open Street Map");
    ...
    {
        private Dimension canvasSize = new Dimension(800, 1000);
    ...
    public static void main(String[] args)
    {
        ...
        BuildingApp.start("World Wind Application", AppFrame.class);
    }
}
